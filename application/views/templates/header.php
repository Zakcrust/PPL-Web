...
-->
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/font-awesome-4.7.0/css/font-awesome.min.css') ?>"> <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/templatemo-style.css') ?>"> <!-- Templatemo style -->
