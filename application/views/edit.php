                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="<?php echo base_url('User/simpanData') ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <textarea name="description" id="" cols="30" rows="10" placeholder="Masukkan deskripsi singkat mengenai rute dan bis"></textarea>
                                    </div>
                                    ...
                                    <?php
                                    if (isset($_SESSION['data_invalid'])) {
                                    ?>
                                        <div class="alert alert-danger" role="alert">
                                            <?php echo $_SESSION['data_invalid'] ?>
                                        </div>
                                    <?php }
                                    ?>

                                    <?php
                                    if (isset($_SESSION['data_valid'])) {
                                    ?>
                                        <div class="alert alert-success" role="alert">
                                            <?php echo $_SESSION['data_valid'] ?>
                                        </div>
                                    <?php }
                                    ?>
